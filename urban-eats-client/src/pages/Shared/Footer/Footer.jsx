const Footer = () => {
  return (
    <>
      <section section className="w-full bg-black">
        <div className="px-8 py-12 mx-auto max-w-7xl">
          <div className="grid grid-cols-2 gap-10 mb-3 md:grid-cols-3 lg:grid-cols-12 lg:gap-20">
            ...
            <nav className="col-span-1 md:col-span-1 lg:col-span-2">
              ...
              <a
                href="#"
                className="flex mb-3 text-sm font-medium text-white transition  md:mb-2 hover:text-primary"
              >
                Features
              </a>
              <a
          ...
          <div className="flex flex-col items-start justify-between pt-10 mt-10 border-t border-gray-100 md:flex-row md:items-center">
            <p className="mb-6 text-sm text-left text-white md:mb-0">
              © Copyright {new Date().getFullYear()} Urban Eats. All Rights
              Reserved.
            </p>
            <div className="flex items-start justify-start space-x-6 md:items-center md:justify-center">
              <a
                href="#_"
                className="text-sm text-white transition hover:text-primary"
              >
                Terms
              </a>
              <a
